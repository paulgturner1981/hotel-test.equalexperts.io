...
As this is a single-page app with limited functionality I decided to focus my session based testing on the core functionality of the site: the input forms, the datepicker and the "Save"/"Delete" functions. All defects discovered during this testing were raised in the attached defect report.
